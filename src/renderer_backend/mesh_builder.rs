...
pub fn make_triangle(device: &wgpu::Device) -> wgpu::Buffer {
    let vertices: [Vertex; 3] = [
        Vertex { position: Vec3::new(-0.75, -0.75, 0.75), color: Vec3::new(1.0, 0.0, 0.0) },
        Vertex { position: Vec3::new(0.75, -0.75, 0.75), color: Vec3::new(0.0, 1.0, 0.0) },
        Vertex { position: Vec3::new(0.0, 0.75, 0.75), color: Vec3::new(0.0, 0.0, 1.0) }
    ];
